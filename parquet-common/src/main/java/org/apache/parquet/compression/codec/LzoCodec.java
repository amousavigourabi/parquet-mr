...
public class LzoCodec implements CompressionCodec {
  ...
  public InputStream createInputStream(ByteBufferInputStream inputStream) throws IOException {
    throw new CodecNotYetImplementedException("LZO decompression is not yet supported by this CompressionCodecFactory implementation.");
  }

  @Override
  public OutputStream createOutputStream(ByteArrayOutputStream compressedOutBuffer) throws IOException {
    throw new CodecNotYetImplementedException("LZO compression is not yet supported by this CompressionCodecFactory implementation.");
  }
